...
void Display::Initialize() {
  ...
  Serial.printf("Display width expected: %d, height: %d\n", 
                DISPLAY_TYPE::WIDTH, DISPLAY_TYPE::HEIGHT);
...
#ifndef DISPLAY_SKIP_HIBERNATE
  gx_epd_->hibernate();
#else
  Serial.println("[TEST] Skipping display hibernate");
#endif
...
uint16_t Display::ConvertPixel(uint8_t input, uint8_t mask, uint8_t shift) {
  ...
  if (Variant() == kVariant7Color) {
    switch (value) {
      case 0x0: return GxEPD_BLACK;
      case 0x1: return GxEPD_WHITE;
      case 0x2: return GxEPD_GREEN;
      case 0x3: return GxEPD_BLUE;
      case 0x4: return GxEPD_RED;
      case 0x5: return GxEPD_YELLOW;
      case 0x6: return GxEPD_ORANGE;
      default: Serial.printf("Unknown 7-color value: 0x%02X\n", value); return GxEPD_BLACK;
    }
  } else {
    switch (value) {
      case 0x0: return GxEPD_BLACK;
      case 0x1: return GxEPD_WHITE;
      case 0x3: return GxEPD_RED;
      default: Serial.printf("Unknown 3-color value: 0x%02X\n", value); return GxEPD_BLACK;
    }
  }
}
